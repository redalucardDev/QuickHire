...
public class CandidateTest {
  ...
  void shouldGetCandidate() {
    ...
    assertThat(candidate).isEqualTo(new Candidate(candidateId
      , new ContactInfo(
      new ContactInfo.FirstName("john"), new ContactInfo.LastName("defo"), new ContactInfo.Email("john.defo@gmail.com")
      , new ContactInfo.PhoneNumber(""))
      , Candidate.Situation.EMPLOYED, resumeId, prospectId));
